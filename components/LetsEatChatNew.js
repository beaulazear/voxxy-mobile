...
export default function LetsEatChatNew({ visible, onClose }) {
    ...
    // Check if user has saved location - city can exist without lat/lng
    ...
    const timeOfDayOptions = [
        { label: 'Brunch', value: 'brunch', icon: Coffee, desc: 'Morning vibes' },
        { label: 'Lunch', value: 'lunch', icon: Sun, desc: 'Midday meal' },
        { label: 'Dinner', value: 'dinner', icon: ChefHat, desc: 'Evening dining' },
        { label: 'Late Night', value: 'late-night', icon: Moon, desc: 'After hours' }
    ]
    ...
    const getStepContent = () => {
        switch (step) {
            case 1:
                return {
                    title: 'Where are you planning to eat?',
                    subtitle: 'Choose your location for restaurant recommendations'
                }
            case 2:
                return {
                    title: 'When are you going?',
                    subtitle: 'Select the time of day for your meal'
                }
            default:
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (currentLocationUsed && coords) {
                ...
                // Use coordinates if available for saved location
            ...
            // Create responses string (matching the old format)
            const responses = `Time of day: ${selectedTimeOfDay}`

            const payload = {
                activity_name: 'Food',  // Required field
                activity_type: 'Restaurant',  // Capitalized to match backend expectations
                activity_location: activityLocation,
                responses: responses,
                time_of_day: selectedTimeOfDay,
                date_notes: `Looking for ${selectedTimeOfDay} restaurants`,  // Required field
                radius: 10,
            ...
            setIsSubmitting(false) // Stop showing loading
                        ...
                        >
                            {!showSuccess ? (
                                <Animated.View style={[styles.loadingContent, { transform: [{ scale: pulseAnim }] }]}>
                                    ...
                                    <Text style={styles.loadingSubtitleLarge}>Setting up your dining experience...</Text>
                                </Animated.View>
                            ) : (
                                <Animated.View
                                    style={[
                                ...
                                >
                                    ...
                                    <Text style={styles.successSubtitle}>Get ready for amazing recommendations</Text>
                                </Animated.View>
                            )}
                        </Animated.View>
                    </Modal>
