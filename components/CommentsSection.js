                ...
                <View style={[
                    ...
                    {!isMe && (
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                logger.debug('Report button pressed for comment:', comment.id);
                                handleReportComment(comment);
                            }}
                            hitSlop={{ top: 15, bottom: 15, left: 15, right: 15 }}
                            activeOpacity={0.6}
                        >
                            <View style={styles.reportButtonBackground}>
                                <MoreVertical size={16} color="rgba(255, 255, 255, 0.9)" />
                            </View>
                        </TouchableOpacity>
                    )}
                    <Text style={[styles.messageText, !isMe && { paddingRight: 40 }]}>{comment.content}</Text>
...
const styles = StyleSheet.create({
    ...
    reportModalButtons: {
        ...
        padding: 20,
        borderTopWidth: 1,
        borderTopColor: 'rgba(185, 84, 236, 0.15)',
        gap: 12,
    },
    reportCancelButton: {
        flex: 1,
