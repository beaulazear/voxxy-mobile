        ...
        switch (step) {
            case 1:
                return {
                    ...
                    subtitle: 'What beverages set the mood?'
                }
            case 2:
                return {
                    title: 'Night Out Vibe',
                    subtitle: 'What atmosphere are you craving?'
                }
            case 3:
                return {
                    title: 'Budget Range',
                    subtitle: 'What works for the whole night?'
                }
            case 4:
                return {
                    title: 'Special Preferences',
                    subtitle: 'Any specific needs or requests? (optional)'
                }
            case 5:
                return {
                    title: 'Your Availability',
                    subtitle: 'When can you paint the town?'
                }
            default:
...
📝 Special Preferences: ${finalPreferences || 'None'}`.trim()
        ...
        try {
            ...
            Alert.alert('Success!', 'Your night out preferences have been submitted!')
            onClose()
                            ...
                            <View style={styles.savedPreferencesContainer}>
                                ...
                                <View style={styles.preferencesActions}>
                                    ...
                                    <TouchableOpacity 
                                        ...
                                        onPress={() => {
                                            setUseSavedPreferences(false)
                                            setPreferences('No special preferences')
                                        }}
                                    >
